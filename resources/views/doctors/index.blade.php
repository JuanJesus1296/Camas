...
<div class="row flex-grow">
    <div class="col-md-12">
    <a href="{{ route('medicos.export') }}" class="btn btn-dark"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Descargar</a>
      <a href="{{ route('medicos.create') }}" class="btn btn-success float-right"><i class="fa fa-plus"></i> Agregar</a>
    </div>
</div>
